const MindMapButton = () => {
  return (
    <a
      ...
      className="group w-[216px] h-[242px] md:w-[284px] lg:w-[504px] lg:h-[480px] px-3 py-6 md:px-6 bg-accent rounded-xl md:rounded-2xl lg:rounded-3xl flex flex-col justify-between items-start text-start"
    >
